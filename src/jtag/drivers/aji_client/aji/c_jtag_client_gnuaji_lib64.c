...
AJI_ERROR AJI_API c_aji_get_nodes_bi(
    ...
    DWORD* hier_id_n,
    AJI_HUB_INFO* hub_infos) {
    AJI_ERROR _Z13aji_get_nodesP9AJI_CHAINjP11AJI_HIER_IDPjP12AJI_HUB_INFOi(AJI_CHAIN_ID, DWORD, AJI_HIER_ID*, DWORD*, AJI_HUB_INFO*, int);
    return _Z13aji_get_nodesP9AJI_CHAINjP11AJI_HIER_IDPjP12AJI_HUB_INFOi(chain_id, tap_position, hier_ids, hier_id_n, hub_infos, 1);
}
